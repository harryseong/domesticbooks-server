...
import com.harryseong.mybookrepo.resources.service.AuthorService;
    ...
    private List<Book> getAuthorBooks(@PathVariable Integer id) {
        ...
        if (a.isPresent()) {
            ...
            if (books.isEmpty()) {
                ...
                LOGGER.info("No mybookrepo have been found by {}", author.getFullName());
            }
